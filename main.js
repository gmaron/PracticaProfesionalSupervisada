...
function ejecutarTop(){
    child = exec("top -n 1 -b > "+appDir+"/top.txt", function (error, stdout, stderr) {
          if (error !== null) {
...
function ejecutarWho(){
    child = exec("who > "+appDir+"/who.txt", function (error, stdout, stderr) {
        if (error !== null) {
            console.log('exec error: ' + error);
        }
    });
...
function ejecutarFree(){
    child = exec("free -m > "+appDir+"/free.txt", function (error, stdout, stderr) {
        if (error !== null) {
            console.log('exec error: ' + error);
        }
    });   
